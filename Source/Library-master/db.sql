 CREATE DATABASE  IF NOT EXISTS `library` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
 USE `library`;
...
CREATE TABLE `authors` (
    ...
    `authorName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `books` (
  `bookId` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `authorId` int DEFAULT NULL,
  `categoryId` int DEFAULT NULL,
  `bookName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `borrow` (
  ...
  `bookId` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `readerId` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `categories` (
  ...
  `categoryName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `readers` (
  `readerId` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `readerName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `readerEmail` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `readerPhoneNumber` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `readers` VALUES ('R71D12','Normal Reader','taducduy2003@gmail.com','0948448484','2024-08-14','Ha Noi',0,25),
                             ...
                             ('RHDB32','Librarian','quangqueee@gmail.com','0948447372','2024-08-22','Ha Noi',0,21);
...
INSERT INTO `users` VALUES (21,'librarian','quang1','librarian'),(24,'latereader','123456','reader'),(25,'normalreader','123456','reader');
